...
from prediction_model.predict import train_accuracy
...
def test_score(single_prediction):
	''' This function will check the accuracy score of training data '''
	data = load_dataset(file_name=config.TRAIN_FILE)
	score = train_accuracy(data)
	assert 70 <= score <= 95
